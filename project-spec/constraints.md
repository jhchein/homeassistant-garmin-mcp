...
- Do not introduce a direct Garmin Connect client or separate Garmin credential store in v1.

## Privacy

- Treat Garmin-derived data as personal fitness data.
- Keep the repository public-ready: no private vault references, customer/work context, real hostnames, or real sample data in committed examples.
...
- `HA_URL` is configured by the user and may point to a local, VPN, reverse-proxied, or container-network Home Assistant endpoint.
